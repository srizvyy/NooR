...
kenny = User.create(username: 'Kenny', password_digest: "password", email: 'kenny@kenny.com', img: '')

william = User.create(username: 'William', password_digest: "password", email: 'william@william.com', img: '')

ben = User.create(username: 'Ben', password_digest: "password", email: 'ben@ben.com', img: '')

alex = User.create(username: 'Alex', password_digest: "password", email: 'alex@alex.com', img: '')

brice = User.create(username: 'Brice', password_digest: "password", email: 'brice@brice.com', img: '')

rohail = User.create(username: 'Rohail', password_digest: "password", email: 'rohail@rohail.com', img: '')
